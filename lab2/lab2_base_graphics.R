...
# Повертаємо режим 1 графік на сторінку (на всякий випадок)
par(mfrow = c(1, 1))
...
# Примітка: minor.tick з Hmisc – опційно. Якщо пакет не встановиться на macOS,
# графік все одно буде коректним (без дрібних поділок).
